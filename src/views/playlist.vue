  ...
  <div v-show="show" class="playlist">
      ...
      <div class="info">
        <div class="title" @click.right="openMenu">
          <span v-if="playlist.privacy === 10" class="lock-icon">
            <i-fluent:lock-multiple-24-filled /> </span
          >{{ playlist.name }}
        </div>
        <div class="artist">
          Playlist by
        ...
        <div class="buttons">
          <ButtonTwoTone @click.native="playPlaylistByID()">
            <template v-slot:icon>
              <i-fluent-play-12-filled @click.native="playPlaylistByID()" />
            </template>
          ...
          >
            <template v-slot:icon>
              <i-fluent:heart-20-regular v-if="!playlist.subscribed" />
              <i-fluent:heart-16-filled v-else />
            </template>
          </ButtonTwoTone>
          <ButtonTwoTone
            :icon-button="true"
          ...
          >
            <template v-slot:icon>
              <i-fluent:more-horizontal-16-filled
                :icon-button="true"
                color="grey"
                @click.native="openMenu"
              >
    ...
    <div v-if="specialPlaylistInfo !== undefined" class="special-playlist">
      ...
      <div class="buttons">
        ...
        <ButtonTwoTone
          v-if="playlist.creator.userId !== data.user.userId"
          :name="playlist.subscribed ? 'heart-solid' : 'heart'"
          :icon-button="true"
          :horizontal-padding="0"
          :color="playlist.subscribed ? 'blue' : 'grey'"
          :text-color="playlist.subscribed ? '#335eea' : ''"
